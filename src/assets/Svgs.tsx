...
export type SVGKey = 'myPage' | 'union' | 'preference' | 'search' | 'smallCheckBoxOpen' | 'smallCheckBoxClosed' | 'bigCheckBoxOpen' | 'bigCheckBoxClosed' | 'arrowLeft' | 'logoBig' | 'logoSmall' | 'mainLogoBig' | 'mainLogoSmall';
