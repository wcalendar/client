...
const calendarDummyDataMonth = (month: number): ResDto<CategoryDto[]> => ({
  ...
  resultBody: [
    ...
    {
      categoryId: 'cc1',
      categoryName: 'CCategory 1',
      categoryLevel: 0,
      categoryColor: 'newPink',
      categoryStartDate: time.toString(time.new(2023, 0), 'YYYY-MM-DD'),
      categoryEndDate: time.toString(time.new(2099, 0), 'YYYY-MM-DD'),
      categoryDescription: "",
      categoryVisible: true,
      schedules: [
        {
          scheduleId: 'ss1',
          categoryId: 'cc1',
          scheduleGroupCode: 'gg1',
          scheduleContent: "SSchedule 1",
          schedulePriority: 0,
          scheduleDate: time.toString(time.new(2024, month, 2), 'YYYY-MM-DD'),
          scheduleStartDate: time.toString(time.new(2024, month, 2), 'YYYY-MM-DD'),
          scheduleEndDate: time.toString(time.new(2024, month, 3), 'YYYY-MM-DD'),
